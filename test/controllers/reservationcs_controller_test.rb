...
class ReservationcsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reservationc" do
    assert_difference('Reservationc.count') do
      post reservationcs_url, params: { reservationc: { start_time: @reservationc.start_time, user_id: @reservationc.user_id } }
    end
  ...
  test "should update reservationc" do
    patch reservationc_url(@reservationc), params: { reservationc: { start_time: @reservationc.start_time, user_id: @reservationc.user_id } }
